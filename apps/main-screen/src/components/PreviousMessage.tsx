...
export const PreviousMessage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-8 mt-16">
      <h2 className="text-center text-3xl font-medium text-white italic font-semibold">
      ...
      <section className="flex min-h-[220px] flex-col items-center justify-center rounded-[44px] bg-white px-10 py-14 text-center text-[#1b1b1b]">
        <p className={`text-[32px] font-bold italic leading-relaxed ${hasMessage ? 'text-black' : 'text-black'}`}>
