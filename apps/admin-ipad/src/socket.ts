...
export function triggerTotemMatchActivation(code?: string) {
  ...
  sendCustomEvent("connections:state-changed", {
    completed: true,
    code: code || "",
  });
}
...
export function resetTabletFeedback() {
  sendCustomEvent("tablet-feedback:reset", {});
}
